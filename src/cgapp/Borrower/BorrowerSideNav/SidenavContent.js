        ...
        return (
            <CustomScrollbars className=" scrollbar">
                <ul className="nav-menu">
                    ...
                    <li className="nav-header">loan</li>

                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/loan/Apply">
                            <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                            <span className="nav-text">Apply</span>
                        </NavLink>
                    </li>

                    <li className="menu no-arrow">
                        <NavLink to="/Borrower/Loan/Existing">
                            <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                            <span className="nav-text">Existing</span>
                        </NavLink>
                    </li>

                   <li className="menu no-arrow">
                        <NavLink to="/Borrower/Loan/Doc">
                            <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
